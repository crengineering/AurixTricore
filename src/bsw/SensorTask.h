...
/** Pull the per-motor ESC telemetry status from the DShot driver and publish
 *  it (Xcp_Esc): last packet, packet count and miss count per motor, CRC
 *  failures on the shared wire. 20 ms (50 Hz). */
